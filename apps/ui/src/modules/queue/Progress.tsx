...
function Progress({ isDone, percent, progressIcon }: ProgressProps) {
  return (
      <Grid container={true}>
        <Grid item={true} sx={{ alignItems: 'center', display: 'flex', pr: 1 }} xs={'auto'}>
          {isDone ? <CheckCircleIcon color={'success'}/> : progressIcon}
        </Grid>
        ...
        <Grid item={true} sx={{ alignItems: 'center', display: 'flex', justifyContent: 'center' }} xs={1}>
