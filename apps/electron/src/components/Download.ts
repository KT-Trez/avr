...
// { this.error = error; this.hasError = hasError; this.hasFinished = hasFinished; this.id = id; this.isSubscribed =
// isSubscribed; this.name = name; this.progress = progress; this.status = status; } }
