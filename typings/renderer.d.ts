...
declare global {
  interface EventTarget {
    addEventListener<K extends keyof YT_DL.GUI.Events.CustomEventMap>(
        type: K,
        listener: (this: Document, ev: YT_DL.GUI.Events.CustomEventMap[K]) => void,
    ): void;

    removeEventListener<K extends keyof YT_DL.GUI.Events.CustomEventMap>(
        type: K,
        listener: (this: Document, ev: YT_DL.GUI.Events.CustomEventMap[K]) => void,
    ): void;
  }
